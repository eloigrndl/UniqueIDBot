...
while(source_link):
    ...
    for page in pages_list:
        ...
        doc = nlp(page_name)
        for e in doc.ents:
           if e.label_ == 'DATE' and len(page_name) == 10:
                print(page_name,' is a date')
                break
           '''if e.label_ == 'PERSON' and len(page_name.split()) <= 4 and page_name[0].isalpha():
                print(page_name,' is a person')
                break'''
        '''
